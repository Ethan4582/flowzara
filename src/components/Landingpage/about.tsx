...
// Testimonials data - SEO optimized for Task Board application
const testimonials = [
  {
    name: "Alex Morgan",
    ...
    quote:
      "“TaskFlow has completely transformed how our team manages projects. The drag‑and‑drop board is intuitive, and the activity log keeps everyone accountable. Highly recommended!”",
  },
  {
    name: "Jamie Lee",
    ...
    quote:
      "“The ability to filter by priority and search tasks instantly saves us hours. TaskFlow’s clean interface makes sprint planning effortless.”",
  },
  {
    name: "Taylor Smith",
  ...
  },
  {
    ...
    quote:
      "“Simple, fast, and reliable. TaskFlow’s ‘Remember Me’ and persistent state mean I never lose my board, even after a browser restart.”",
  },
  {
    name: "Morgan Casey",
  ...
  },
  {
    ...
    quote:
      "“We evaluated several tools, but TaskFlow’s clean design and no‑backend approach won us over. It’s exactly what a small agile team needs.”",
  },
  {
    name: "Blair Kennedy",
    ...
    quote:
      "“I use TaskFlow for both work and personal projects. The due date handling and priority filters keep me on top of deadlines.”",
  },
];
      ...
      <section className="relative z-[3] w-full">
        <div className="px-4 py-0 md:px-[15px] md:pb-[120px]">
          <div className="mx-auto w-full max-w-[1140px]">
            {/* Decorative empty divs (kept for original layout) */}
            <div
            ...
            <div className="mb-12 md:mb-[60px]">
              <div className="mx-auto max-w-[538px] text-center">
                <h2 className="text-4xl font-bold leading-tight md:text-5xl md:leading-[57.6px]">
                  What Users Say About TaskFlow
                </h2>
              </div>
            </div>

            {/* Testimonials grid - responsive: 1 col on mobile, 3 cols on md+ */}
                  ...
                  <div className="mb-6">
                    <div className="flex items-center justify-start gap-2.5">
                      <img
                        alt={t.name}
                        src={t.image}
                        className="block h-[45px] w-[45px] max-w-full overflow-clip rounded-full object-cover align-middle"
                      />
                      <div>
        ...
        {/* Background blur elements (kept as is) */}
